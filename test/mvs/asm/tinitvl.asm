...
*    TINITVL OK   ENVBLOCK=xxxxxxxx RC=xxxxxxxx REASON=xxxxxxxx
*    TINITVL FAIL ENVBLOCK=xxxxxxxx RC=xxxxxxxx REASON=xxxxxxxx
*
...
*  R14 = caller link. Uses R1,R2. ENV at +22, RC at +34, RSN at +50
...
*  Generated by the WTO macro; this is the read-only template that
*  WTOSETUP copies into the writable WTOWORK area. Text starts at
*  offset +4 (after AL2 length + AL2 MCSFLAG).
WTOSKEL  WTO   MF=L,                                                   *
               TEXT='                                                            '
WTOSKLEN EQU   *-WTOSKEL
*
*  --- 60-char message templates (text portion of WPL) ------------
*    01234567890123456789012345678901234567890123456789012345678901
*    0         1         2         3         4         5         6
*    TINITVL OK   ENVBLOCK=XXXXXXXX RC=XXXXXXXX REASON=XXXXXXXX
*                          ^22       ^31  ^34       ^46    ^50
*  Hex slots: ENV@22, RC@34, RSN@50 (8 chars each, all positions 0-based)
OKMSG    DC    CL60'TINITVL OK   ENVBLOCK=XXXXXXXX RC=XXXXXXXX REASON=XXXXXXXX'
FAILMSG  DC    CL60'TINITVL FAIL ENVBLOCK=XXXXXXXX RC=XXXXXXXX REASON=XXXXXXXX'
MSGLEN   EQU   60
*
